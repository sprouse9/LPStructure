...
int main()
{
	...
	//basePtr->world->player->setMaxHealth();
	//Vector3 test = basePtr->camera->getObjectCoord();
	basePtr->world->player->teleportToPointedObject( basePtr->camera->getObjectCoord() );
	//basePtr->camera->Vector3;
